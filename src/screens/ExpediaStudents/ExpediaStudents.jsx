      ...
      <div className="div-3">
          ...
          >
            <div className="overlap-group-15">
              ...
              <div className="frame-10">
                <h1 className="text-wrapper-44">Expedia: Student Travel User Research</h1>
                <p className="problem-statement">
                  <span className="text-wrapper-45">Problem Statement</span>
                  <span className="text-wrapper-46">: </span>
                  <span className="text-wrapper-47">What are the unique needs of students when they travel? </span>
                </p>
              </div>
            </div>
          </div>
        ...
        <div className="group-33">
          ...
          <div className="frame-11">
            <div className="text-wrapper-48">Overview</div>
          ...
          <div className="frame-12">
            ...
            <div className="frame-13">
              <div className="frame-14">
                ...
                <div className="text-wrapper-51">Affinity Diagramming</div>
                <div className="text-wrapper-52">Survey</div>
                <div className="text-wrapper-53">Persona</div>
              </div>
              <div className="frame-15">
                ...
                <div className="frame-19">
                  <div className="text-wrapper-57">Access to Persona</div>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="group-37">
          <div className="group-38">
            ...
            <img className="line-16" alt="Line" src="/img/line-15.png" />
          </div>
          <div className="frame-20">
            <div className="text-wrapper-58">Recommendations</div>
        ...
        <div className="group-39">
          <div className="group-40">
            ...
            <img className="line-17" alt="Line" src="/img/line-17.png" />
          </div>
          <div className="frame-21">
            <div className="text-wrapper-59">Key Takeaways:</div>
        ...
        <div className="group-41">
          <div className="group-42">
            ...
            <img className="line-18" alt="Line" src="/img/line-11.png" />
          </div>
        ...
        <div className="frame-23">
          <div className="group-43">
            <div className="group-44">
              <div className="overlap-group-16">
                <img className="line-19" alt="Line" src="/img/line-12.png" />
                <Ellipse
                  style={{
                    left: "0",
                    position: "absolute",
            ...
            <div className="frame-24">
              ...
              <div className="flex-container-4">
                ...
                <div className="text-16">
                  <span className="text-wrapper-63">The </span>
                  <a
                    href="https://docs.google.com/document/d/1Xavy7ZAlrbQ3EjBMd16-4IS1n8EDszFLQ9ObC7KnO7A/edit"
                    rel="noopener noreferrer"
                    target="_blank"
                  >
                    <span className="text-wrapper-64">Interview guide</span>
                  </a>
                  ...
                  <span className="text-wrapper-66">Photo elicitation</span>
          ...
          <div className="group-45">
            <div className="group-46">
              ...
              />
              <img className="line-20" alt="Line" src="/img/line-18-1.png" />
            </div>
              ...
              <div className="frame-26">
                ...
                <div className="flex-container-5">
                  ...
                  <div className="text-19">
                    <span className="text-wrapper-70">time efficiency​: </span>
                  ...
                  <div className="text-20">
                    <span className="text-wrapper-72">cost-efficiency: </span>
                  ...
                  <div className="text-21">
                    <span className="text-wrapper-74">organization for clarifying and efficiency: </span>
                  ...
                  <div className="text-22">
                    <span className="text-wrapper-76">Family/friend connections: </span>
                  ...
                  <div className="text-25">
                    <span className="text-wrapper-82">Pre-planning validation: </span>
          ...
          <div className="group-47">
            <div className="group-48">
              ...
              />
              <img className="line-21" alt="Line" src="/img/line-13-1.png" />
            </div>
              ...
              <div className="frame-28">
                ...
                <p className="our-research-team">
                  <span className="text-wrapper-84">
                    ...
                    California, Texas, and New York, representing different regions of America, to explore whether
                    students&#39; geographic location impacts their travel choices. The survey consisted of 20 questions
                    and were focused on confirming our interview conclusions while&nbsp;&nbsp;uncovering factors
                    influencing participants&#39; activity and destination preferences during their travels. To ensure
                    that our survey was not biased or influenced by the behavior of our respondents, we piloted the
                    first versions to beta-test our questions. <br />
                  </span>
                  <a
          ...
          <div className="group-51">
            <div className="group-52">
              ...
              />
              <img className="line-22" alt="Line" src="/img/line-14.png" />
            </div>
          ...
          <div className="group-53">
            <div className="group-54">
              ...
              />
              <img className="line-23" alt="Line" src="/img/line-19.png" />
            </div>
            <div className="frame-31">
              <div className="frame-32">
                ...
                <p className="to-further-empathize">
                  ...
                  because we want to analyze how could we redesign the website to help this common situation. This
                  narrative visualization helped us to have a more concrete idea of users&#39; images and needs when
                  brainstorming. Other members of the team created 2 more journey maps, one used Expedia with a bad
                  ending and one used Expedia with a happy ending, and one experience map to understand generic human
                  traveling behaviors based on data from surveys and interviews.
                </p>
              </div>
              <img className="image-5" alt="Image" src="/img/image-10-1.png" />
            </div>
          </div>
        </div>
      </div>
