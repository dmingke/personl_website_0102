      ...
      <div className="div-10">
        <div className="overlap-17">
          ...
          <div className="frame-17">
            <h1 className="text-wrapper-146">Expedia: Student Travel User Research</h1>
            <p className="problem-statement-2">
              <span className="text-wrapper-147">Problem Statement</span>
              <span className="text-wrapper-148">: </span>
              <span className="text-wrapper-149">What are the unique needs of students when they travel? </span>
            </p>
          </div>
        ...
        <div className="overlap-18">
          <div className="group-44">
            <div className="group-45">
              ...
              <img className="line-5" alt="Line" src="/img/line-10.png" />
            </div>
            <div className="group-46">
              <div className="ellipse-3" />
              <img className="line-6" alt="Line" src="/img/line-16.png" />
            </div>
            <div className="group-47">
              <div className="ellipse-4" />
              <img className="line-7" alt="Line" src="/img/line-11.png" />
            </div>
            ...
            <div className="group-52">
              <div className="overlap-19">
                ...
                <img className="line-12" alt="Line" src="/img/line-12.png" />
              </div>
            </div>
            <div className="group-53">
              <div className="group-54" />
              <img className="line-13" alt="Line" src="/img/line-18.png" />
            </div>
            <div className="group-55">
              <div className="ellipse-10" />
              <img className="line-14" alt="Line" src="/img/line-13.png" />
            </div>
          </div>
          <div className="group-56">
            ...
            <div className="flex-container-15">
              ...
              <div className="text-70">
                <span className="text-wrapper-152">
                  ...
                  site to another to make a decision. We start to wonder if having to use tons of apps to plan a trip
                  was only my main frustration with using online travel platforms and what their primary needs are when
                  they travel. Knowing that we want to try redesigning Expedia to generate a better user experience for
                  students (aged 18-25). All team members are from the UX education student organization, a newly
                  founded student institution. I invited them to carry out this UX research project as an organizational
                  activity.
                </span>
              </div>
            </div>
            ...
            <div className="flex-container-16">
              ...
              <div className="text-73">
                <span className="text-wrapper-155">time efficiency​: </span>
              ...
              <div className="text-74">
                <span className="text-wrapper-157">cost-efficiency: </span>
              ...
              <div className="text-75">
                <span className="text-wrapper-159">organization for clarifying and efficiency: </span>
              ...
              <div className="text-76">
                <span className="text-wrapper-161">Family/friend connections: </span>
              ...
              <div className="text-77">
                <span className="text-wrapper-163">Flexibility: </span>
                <span className="text-wrapper-164">
                  valuing the ability to adjust the plan according to their interests; <br />
                </span>
              </div>
              <div className="text-78">
                <span className="text-wrapper-165">Comfort: t</span>
                <span className="text-wrapper-166">
                  raveling in a comfortable and fun way;
                  <br />
                </span>
              </div>
              <div className="text-79">
                <span className="text-wrapper-167">Pre-planning validation: </span>
            ...
            <div className="flex-container-17">
              <div className="text-80">
                <span className="text-wrapper-169">
                  Participants recruiting requirements: 10 college students who have traveled within the past 6 months;
                  <br />
                </span>
              </div>
              <div className="text-81">
                <span className="text-wrapper-170">The </span>
                <a
                  href="https://docs.google.com/document/d/1Xavy7ZAlrbQ3EjBMd16-4IS1n8EDszFLQ9ObC7KnO7A/edit"
                  rel="noopener noreferrer"
                  target="_blank"
                >
                  <span className="text-wrapper-171">Interview guide</span>
                </a>
                <span className="text-wrapper-172">
                  {" "}
                  was discussed and prepared before all interviews. All questions were ensured to be descriptive and not
                  leading.{" "}
                </span>
                <span className="text-wrapper-173">Photo elicitation</span>
            ...
            <p className="our-research-team">
              <span className="text-wrapper-175">
                Our research team conducted a survey to gain further insights into the travel needs of college students.
                We had previously conducted interviews, and the survey was designed to validate our assumptions and
                gather additional evidence. We selected 100 college students from Michigan, California, Texas, and New
                York, representing different regions of America, to explore whether students&#39; geographic location
                impacts their travel choices. The survey consisted of 20 questions and were focused on confirming our
                interview conclusions while&nbsp;&nbsp;uncovering factors influencing participants&#39; activity and
                destination preferences during their travels. To ensure that our survey was not biased or influenced by
                the behavior of our respondents, we piloted the first versions to beta-test our questions. <br />
              </span>
              <a
                ...
                target="_blank"
              >
                <span className="text-wrapper-176">
                  <br />
                </span>
              </a>
              <span className="text-wrapper-177">
                The survey provided our team with valuable quantitative and qualitative data, shedding light on several
                key themes regarding students&#39; travel needs. These themes included the importance of cost,
                interpersonal relationships, engagement in fun and outdoor activities, preference for beach
                destinations, and the significance of time efficiency. By analyzing the responses of the 100 college
                students from different states, we were able to draw meaningful conclusions about the factors
                influencing their travel choices.
              </span>
            </p>
            <p className="collecting-survey">Collecting Survey Data And Visualizing</p>
            <div className="text-wrapper-178">Recommendations</div>
            ...
            <div className="group-58">
              ...
              <div className="text-wrapper-179">Affinity Diagramming</div>
              <div className="text-wrapper-180">Survey</div>
              <div className="text-wrapper-181">Persona</div>
            ...
            <p className="text-wrapper-182">
              ...
              website/app, our personal experience can greatly influence the conclusions drawn from the data. In order
              to prevent it from happening, it is very useful for me to repeatedly reflect on whether I make assumptions
              ahead of time.
            </p>
            <p className="for-current-expedia">
              For current Expedia.com, based on the data we gathered, I proposed a few recommendations： <br />
              when booking flights or stays, platforms can first ask about the purpose of travel, vacation, or business;
              if travel for vacation, stays, flights, car rents, and attractions are recommended to be booked at once as
              a big travel package. One option is that Expedia.com can collaborate with Yelp.com to make bookings
              (Yelp.com was mentioned as one of the most frequent sites to make travel plans). Attraction tickets can
              also be booked in this comprehensive package. Moreover, the most frequently booked package can be
              recommended to users and enable them to make adjustments to this package. The site currently separates
              booking flights or stays. Based on the data, I would suggest making it a shopping cart in which they can
              add all products (e.g., flights, hotels, attractions tickets, or reservations), book and make payment all
              at once with less effort required.
              <br />
              ...
              <br />
              the app can provide a tool to compare costs between different travel plans when users add or remove an
              item like flight reservations.
              <br />
            ...
            <div className="text-wrapper-183">Key Takeaways:</div>
            <p className="based-off-of-the">
              Based off of the data we gathered, we began to fabricate user personas to understand the different types
              of people concerned by focusing on two main themes from affinity map and survey.&nbsp;&nbsp;Madison Jones
              is the personas for primary users for the Expedia student website.
            </p>
            <p className="text-wrapper-184">
              To further empathize and visualize the primary user, I created a journey map of Madison Jones’s a specific
              travel experience for a more concrete image of our main user.
            </p>
            ...
            <p className="text-wrapper-185">
              ...
              our 10 interviewees in 15-minutes interviews each, we conducted an affinity diagramming to analyze our
              qualitative data.
            </p>
            <img className="image-11" alt="Image" src="/img/image-10-1.png" />
          </div>
        </div>
        </div>
        <NavigationBar
