    ...
    <div className="freeze">
      <div className="div-4">
        <div className="flex-container-9">
          ...
          <div className="text-37">
            <span className="text-wrapper-57">
              ​Design process and Rationale: The idea of this app came into my mind when I was looking at my fridge and
              thinking about what to eat today. However, I had nothing in my mind. At another time, I was cleaning the
              fridge and finding there are many items expired but it even has not been opened. These issues I had are my
              reason to design this app. I started my design by formalizing my ideas on the document, writing the
              problem statement, persona, use cases, and scenario. After that, I asked for advice for improvement. I did
              not consider those ingredients won&#39;t store in the fridge, so I added them to my use cases. Then, I
              designed an experiment to test my LOF assumption. I asked subjects to remember the items that they sorted
              previously after 5 hours. They barely remembered the items, which justified that shoppers are easy to
              forget what they had in the fridge after a certain period, so they do have the need for my app to record.
              I had some issues visualizing my idea. How to make the app smoothly achieve the purpose is not very direct
              to me. I separated the problem into three pieces, recording items in the fridge, shopping list, and
              suggesting recipes. Starting with the low-fidelity design, I drew the wireframe of several possible ideas
              firstly on Balsamiq Wireframes and chose the one I like for more advice. Since the layout of the shopping
              list is similar to the fridge recording list. It is difficult to distinguish, so I modified the layout.
              After finishing the prototype on Figma, I asked for more advice and revised several details.
            </span>
          </div>
        </div>
        ...
        <p className="text-wrapper-58">
          Problem Statement: People who are not familiar with cooking or buy groceries frequently want to manage their
          grocery purchases and cooking plans because they are likely to forget what they already brought or have no
          idea about what to eat based on the food in the refrigerator.
        </p>
